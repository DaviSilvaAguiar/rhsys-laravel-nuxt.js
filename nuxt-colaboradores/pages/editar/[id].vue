      ...
      <form @submit.prevent="salvar">
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input type="text" v-model="colaborador.nome_completo" required />
          </div>
          <div class="form-group">
            <label for="apelido">Apelido</label>
            <input type="text" v-model="colaborador.apelido" required />
          </div>
        </div>
        <div class="form-row">
          <div class="form-group">
            <label for="nome_pai">Nome do Pai</label>
            <input type="text" v-model="colaborador.nome_pai" />
          </div>
          <div class="form-group">
            <label for="nome_mae">Nome da Mãe</label>
            <input type="text" v-model="colaborador.nome_mae" />
          </div>
        </div>
        <div class="form-row">
          <div class="form-group">
        ...
        <div class="button-group">
          ...
          <div class="right-buttons">
            <BaseButton type="cadastrar">{{ modo === 'editar' ? 'Salvar' : 'Cadastrar' }}</BaseButton>
          </div>
        </div>
      </form>
    </div>
...
const { colaborador, salvar, cancelar, permitirSomenteNumeros, cpfInvalido, formatarCpf } = useEditar()
